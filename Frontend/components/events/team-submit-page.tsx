      ...
      <div className="min-h-screen bg-background flex flex-col items-center justify-center px-6 py-16">
        ...
        >
          ...
          <p className="text-sm text-neutral-400 leading-relaxed">
            Your repository analysis has started. The organizer will see your submission on their dashboard.
          </p>
          <Link
            href="/"
        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
          ...
          {!event && (
            <p className="mt-2 text-sm text-neutral-500">
              Paste the link your organizer shared. Your submission will be attached to this event.
            </p>
          )}
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-4">
            ...
            <div className="space-y-1.5">
              <label className="text-sm font-semibold text-neutral-300">
                Branch <span className="text-neutral-500 font-normal">(optional)</span>
              </label>
